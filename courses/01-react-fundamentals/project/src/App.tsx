      ...
      <div className="App">
        <main>
          <Routes>
            ...
            <Route path="/challenge/20-error-boundaries" element={<TaskApp tasks={tasks} setTasks={setTasks} showForm showFilterBar showStatsPanel onDelete={handleDelete} />} />
            ...
            <Route path="/challenge/23-useref-focus-management" element={<TaskApp tasks={tasks} setTasks={setTasks} showForm showFilterBar showStatsPanel onDelete={handleDelete} />} />
          </Routes>
        </main>
      </div>
    </BrowserRouter>
